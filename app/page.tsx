...
export default function Home() {
  ...
  const generatePortraits = async (overridePrompt?: string) => {
    ...
    try {
      ...
      console.log("☁️ [3/4] Sending to Wolfram Cloud for Sketch effect...");
      ...
      if (!wolframResponse.ok) {
        console.warn("⚠️ Wolfram failed. Showing Gemini originals.");
            ...
            <div className="bg-gray-900/60 border border-gray-800 rounded-xl p-4">
              ...
              {basicFieldsMissing() && (
                <p className="mt-2 text-xs text-yellow-400">
                  ⚠ Some basic fields are missing (for example: face
